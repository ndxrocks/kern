...
from kern.remote.base import BaseRemote, RemoteDb
...
class RemoteWorkflow(BaseRemote):
    ...
    def _arun_a2a(
        ...
        from kern.client.a2a.utils import map_stream_events_to_workflow_run_events
    ...
    async def _arun_a2a_send(
        ...
        if not self.a2a_client:
            raise ValueError("A2A client not available")
        from kern.client.a2a.utils import map_task_result_to_workflow_run_output
