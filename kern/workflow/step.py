...
from kern.models.metrics import RunMetrics
from kern.registry import Registry
from kern.run import RunContext
from kern.run.agent import RunContentEvent, RunOutput
...
from kern.utils.log import log_debug, log_warning, logger, use_agent_logger, use_team_logger, use_workflow_logger
...
class Step:
    ...
    def __init__(
        ...
        if executor is not None:
            from kern.workflow.decorators import get_pause_metadata
    ...
    def from_dict(
        ...
        if "agent_id" in config and config["agent_id"]:
            ...
            if agent is None and db is not None and agent_id is not None:
                from kern.agent.agent import get_agent_by_id
        ...
        if "team_id" in config and config["team_id"]:
            ...
            if team is None and db is not None and team_id is not None:
                from kern.team.team import get_team_by_id
