...
if TYPE_CHECKING:
    ...
    from kern.workflow.types import StepInput, StepRequirement, WorkflowExecutionInput
...
def create_step_paused_event(
    ...
    """
    from kern.run.workflow import StepPausedEvent
...
def create_router_paused_event(
    ...
    """
    from kern.run.workflow import RouterPausedEvent
