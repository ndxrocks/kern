...
from kern.os.interfaces.telegram.events import dispatch_stream_event
from kern.os.interfaces.telegram.helpers import (
    extract_message_payload,
    is_bot_mentioned,
    send_message,
    send_response_media,
)
from kern.os.interfaces.telegram.security import validate_webhook_secret_token
from kern.os.interfaces.telegram.state import BotState, StreamState, build_session_store_config, find_latest_session_id
...
try:
    ...
    raise ImportError("`pyTelegramBotAPI` not installed. Please install using `pip install 'kern[telegram]'`") from e
