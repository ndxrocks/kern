...
from kern.os.interfaces.whatsapp.helpers import (
    WhatsAppConfig,
...
from kern.os.interfaces.whatsapp.security import validate_webhook_signature
...
def attach_routes(
    ...
    async def process_message(message: dict):
        ...
        try:
            ...
            # Download media from Meta servers and wrap as Kern media objects
