"""Main class for the AG-UI app, used to expose an Kern Agent or Team in an AG-UI compatible format."""
...
from kern.os.interfaces.agui.router import attach_routes
