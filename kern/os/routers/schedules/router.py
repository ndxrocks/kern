...
from kern.os.routers.schedules.schema import (
    ScheduleCreate,
    ScheduleResponse,
    ScheduleRunResponse,
...
from kern.os.schema import PaginatedResponse, PaginationInfo
...
def get_schedule_router(os_db: Any, settings: Any) -> APIRouter:
    ...
    Args:
        ...
        settings: KernAPISettings instance.
    ...
    def _check_scheduler_deps() -> None:
        ...
        try:
            from kern.scheduler.cron import _require_croniter, _require_pytz
    ...
    async def enable_schedule(
        ...
        _check_scheduler_deps()
        from kern.scheduler.cron import compute_next_run
