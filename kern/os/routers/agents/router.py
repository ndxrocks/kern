...
from kern.run.agent import RunErrorEvent, RunOutput
from kern.run.base import RunStatus
from kern.utils.log import log_debug, log_error, log_warning
...
def get_agent_router(
                        ...
                        "example": [
                            {
                                ...
                                "tools": None,
                                "sessions": {"session_table": "kern_sessions"},
    ...
    async def get_agents(request: Request) -> List[AgentResponse]:
        ...
        if os.db and isinstance(os.db, BaseDb):
            from kern.agent.agent import get_agents
    ...
    async def list_agent_runs(
        ...
        from kern.os.schema import RunSchema
        ...
        from kern.agent._storage import aread_or_create_session
