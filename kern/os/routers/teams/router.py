...
from kern.db.base import BaseDb
from kern.exceptions import InputCheckError, OutputCheckError
from kern.media import Audio, Image, Video
from kern.media import File as FileMedia
from kern.os.auth import get_auth_token_from_request, get_authentication_dependency, require_resource_access
...
from kern.utils.log import log_warning, logger
...
def get_team_router(
    os: "AgentOS",
    settings: KernAPISettings = KernAPISettings(),
                                ...
                                "members": [
                                    {
                                        ...
                                        "session_table": "kern_sessions",
                                        "memory_table": "kern_memories",
                                    }
                                ],
                                "enable_agentic_context": False,
                                "memory": {
                                    "app_name": "kern_memories",
                                    "app_url": "/memory/1",
                                    "model": {"name": "OpenAIChat", "model": "gpt-4o", "provider": "OpenAI"},
                                },
                                "async_mode": False,
    ...
    async def get_teams(request: Request) -> List[TeamResponse]:
        ...
        if getattr(request.state, "authorization_enabled", False):
            from kern.os.auth import filter_resources_by_access, get_accessible_resources
        ...
        if os.db and isinstance(os.db, BaseDb):
            from kern.team.team import get_teams
    ...
    async def list_team_runs(
        ...
        from kern.os.schema import TeamRunSchema
        from kern.team._storage import _aread_or_create_session
