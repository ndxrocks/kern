...
from kern.os.managers import event_buffer, websocket_manager
...
from kern.utils.log import log_debug, log_warning, logger
...
def get_workflow_router(
    ...
    async def get_workflows(request: Request) -> List[WorkflowSummaryResponse]:
        ...
        if os.db and isinstance(os.db, BaseDb):
            from kern.workflow.workflow import get_workflows
