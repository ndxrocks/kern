...
from kern.os.scopes import get_accessible_resource_ids, has_required_scopes
...
def get_authentication_dependency(settings: KernAPISettings):
    """
...
def validate_websocket_token(token: str, settings: KernAPISettings) -> bool:
    """
