...
from kern.run.team import TeamRunEvent, TeamRunOutput, TeamRunOutputEvent
from kern.utils.log import log_warning
from kern.utils.message import get_text_from_message
from kern.utils.response import build_reasoning_step_panel, create_panel, escape_markdown_tags, format_tool_calls
...
def print_response(
    ...
    **kwargs: Any,
    ...
    from kern.utils.response import format_tool_calls
