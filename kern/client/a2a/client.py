"""A2A (Agent-to-Agent) protocol client for Kern.
...
from kern.client.a2a.schemas import AgentCard, Artifact, StreamEvent, TaskResult
...
class A2AClient:
    ...
    agent server, including Kern AgentOS with a2a_interface=True.
    ...
    def _parse_stream_event(self, data: Dict[str, Any]) -> StreamEvent:
        ...
        if kind == "task":
            ...
            if metadata and metadata.get("kern_content_category") == "reasoning":
