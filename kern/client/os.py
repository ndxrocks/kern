...
from kern.db.schemas.evals import EvalFilterType, EvalType
from kern.exceptions import RemoteServerUnavailableError
from kern.media import Audio, File, Image, Video
from kern.media import File as MediaFile
from kern.models.response import ToolExecution
from kern.os.routers.agents.schema import AgentResponse
from kern.os.routers.evals.schemas import (
    DeleteEvalRunsRequest,
    EvalRunInput,
    EvalSchema,
    UpdateEvalRunRequest,
)
from kern.os.routers.knowledge.schemas import (
...
from kern.os.routers.memory.schemas import (
...
from kern.os.routers.metrics.schemas import DayAggregatedMetrics, MetricsResponse
from kern.os.routers.teams.schema import TeamResponse
from kern.os.routers.traces.schemas import (
    TraceDetail,
    TraceNode,
    TraceSearchGroupBy,
    TraceSessionStats,
...
from kern.os.routers.workflows.schema import WorkflowResponse
from kern.os.schema import (
...
from kern.run.agent import RunOutput, RunOutputEvent, run_output_event_from_dict
from kern.run.team import TeamRunOutput, TeamRunOutputEvent, team_run_output_event_from_dict
from kern.run.workflow import WorkflowRunOutput, WorkflowRunOutputEvent, workflow_run_output_event_from_dict
from kern.utils.http import get_default_async_client, get_default_sync_client
...
class AgentOSClient:
    ...
    async def upload_knowledge_content(
        ...
        if file:
            # Handle both kern.media.File and FastAPI UploadFile
