"""
Custom OpenTelemetry SpanExporter that writes traces to Kern database.
"""
...
from kern.tracing.schemas import Span, create_trace_from_spans
from kern.utils.log import logger


class DatabaseSpanExporter(SpanExporter):
    """Custom OpenTelemetry SpanExporter that writes to Kern database"""
