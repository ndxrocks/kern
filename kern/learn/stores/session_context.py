...
from kern.learn.config import LearningMode, SessionContextConfig
from kern.learn.schemas import SessionContext
from kern.learn.stores.protocol import LearningStore
from kern.learn.utils import from_dict_safe, to_dict_safe
...
from kern.utils.message import get_conversation_text
...
class SessionContextStore(LearningStore):
    ...
    def print(self, session_id: str, *, raw: bool = False) -> None:
        ...
        Example:
            ...
            ╰──────────────── sess_123 ─────────────────────╯
        """
        from kern.learn.utils import print_panel
