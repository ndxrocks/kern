...
from kern.exceptions import AgentRunException
from kern.media import Audio, File, Image, Video
from kern.run import RunContext
from kern.utils.log import log_debug, log_error, log_exception, log_warning
...
class Function(BaseModel):
    ...
    def from_callable(cls, c: Callable, name: Optional[str] = None, strict: bool = False) -> "Function":
        ...
        from kern.utils.json_schema import get_json_schema
    ...
    def _get_cache_file_path(self, cache_key: str) -> str:
        ...
        base_cache_dir = self.cache_dir or Path(gettempdir()) / "kern_cache"
