                    ...
                    if hasattr(part, "inline_data") and part.inline_data:
                        try:
                            ...
                            if image_data:
                                ...
                                generated_images.append(kern_img)

                                log_debug(f"Successfully processed image with ID: {kern_img.id}")
                                response_str += f"Image generated successfully (ID: {kern_img.id}).\n"
