...
from kern.reasoning.step import NextAction, ReasoningStep, ReasoningSteps
from kern.run.base import RunContext
from kern.run.messages import RunMessages
from kern.tools import Toolkit
from kern.tools.function import Function
from kern.utils.log import log_debug, log_error, log_info, log_warning

if TYPE_CHECKING:
    from kern.agent import Agent
    from kern.metrics import RunMetrics
...
class ReasoningManager:
    ...
    def _detect_model_type(self, model: Model) -> Optional[str]:
        ...
        from kern.reasoning.anthropic import is_anthropic_reasoning_model
        from kern.reasoning.azure_ai_foundry import is_ai_foundry_reasoning_model
        from kern.reasoning.deepseek import is_deepseek_reasoning_model
        from kern.reasoning.gemini import is_gemini_reasoning_model
        from kern.reasoning.groq import is_groq_reasoning_model
        from kern.reasoning.ollama import is_ollama_reasoning_model
        from kern.reasoning.openai import is_openai_reasoning_model
        from kern.reasoning.vertexai import is_vertexai_reasoning_model
    ...
    def _get_reasoning_agent(self, model: Model) -> "Agent":
        ...
        from kern.reasoning.helpers import get_reasoning_agent
    ...
    def _get_default_reasoning_agent(self, model: Model) -> Optional["Agent"]:
        ...
        from kern.reasoning.default import get_default_reasoning_agent
    ...
    def get_native_reasoning(self, model: Model, messages: List[Message]) -> ReasoningResult:
        ...
        try:
            if model_type == "deepseek":
                from kern.reasoning.deepseek import get_deepseek_reasoning
                ...
                from kern.reasoning.anthropic import get_anthropic_reasoning
                ...
                from kern.reasoning.openai import get_openai_reasoning
                ...
                from kern.reasoning.groq import get_groq_reasoning
                ...
                from kern.reasoning.ollama import get_ollama_reasoning
                ...
                from kern.reasoning.azure_ai_foundry import get_ai_foundry_reasoning
                ...
                from kern.reasoning.gemini import get_gemini_reasoning
                ...
                from kern.reasoning.vertexai import get_vertexai_reasoning
    ...
    def stream_native_reasoning(
        ...
        if model_type == "deepseek":
            from kern.reasoning.deepseek import get_deepseek_reasoning_stream
            ...
            from kern.reasoning.anthropic import get_anthropic_reasoning_stream
            ...
            from kern.reasoning.gemini import get_gemini_reasoning_stream
            ...
            from kern.reasoning.openai import get_openai_reasoning_stream
            ...
            from kern.reasoning.vertexai import get_vertexai_reasoning_stream
            ...
            from kern.reasoning.azure_ai_foundry import get_ai_foundry_reasoning_stream
            ...
            from kern.reasoning.groq import get_groq_reasoning_stream
            ...
            from kern.reasoning.ollama import get_ollama_reasoning_stream
    ...
    async def astream_native_reasoning(
        ...
        # Currently only DeepSeek and Anthropic support streaming
        if model_type == "deepseek":
            from kern.reasoning.deepseek import aget_deepseek_reasoning_stream
            ...
            from kern.reasoning.anthropic import aget_anthropic_reasoning_stream
            ...
            from kern.reasoning.gemini import aget_gemini_reasoning_stream
            ...
            from kern.reasoning.openai import aget_openai_reasoning_stream
            ...
            from kern.reasoning.vertexai import aget_vertexai_reasoning_stream
            ...
            from kern.reasoning.azure_ai_foundry import aget_ai_foundry_reasoning_stream
            ...
            from kern.reasoning.groq import aget_groq_reasoning_stream
            ...
            from kern.reasoning.ollama import aget_ollama_reasoning_stream
    ...
    def run_default_reasoning(
        ...
        Yields:
            ...
            - At the end: (None, ReasoningResult)
        """
        from kern.reasoning.helpers import get_next_action, update_messages_with_reasoning
        ...
        while next_action == NextAction.CONTINUE and step_count < self.config.max_steps:
            ...
            try:
                ...
                if self.config.run_metrics is not None:
                    from kern.metrics import accumulate_eval_metrics
