...
from kern.exceptions import ContextWindowExceededError, ModelAuthenticationError, ModelProviderError
...
from kern.utils.models.openai_responses import images_to_message
from kern.utils.models.schema_utils import get_response_schema_for_provider
from kern.utils.tokens import count_schema_tokens
...
class OpenAIResponses(Model):
    ...
    def _format_messages(
        ...
        """
        from kern.utils.message import normalize_tool_messages, reformat_tool_call_ids
    ...
    def _get_metrics(self, response_usage: ResponseUsage) -> MessageMetrics:
        """
        Parse the given OpenAI-specific usage into an Kern MessageMetrics object.
