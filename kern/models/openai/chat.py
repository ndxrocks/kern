...
from kern.utils.openai import _format_file_for_message, audio_to_message, images_to_message
from kern.utils.reasoning import extract_thinking_content
...
class OpenAIChat(Model):
    ...
    def invoke(
        ...
        try:
            ...
            # Parse the response into an Kern ModelResponse object
