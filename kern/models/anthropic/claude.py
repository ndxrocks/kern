...
from kern.exceptions import ModelProviderError, ModelRateLimitError
from kern.models.base import Model
from kern.models.message import Citations, DocumentCitation, Message, UrlCitation
...
from kern.utils.models.claude import (
...
class Claude(Model):
    ...
    def _handle_api_error(self, e: Exception) -> NoReturn:
        """Convert Anthropic SDK exceptions into Kern model exceptions.
    ...
    def _get_metrics(self, response_usage: Union[Usage, MessageDeltaUsage, BetaUsage]) -> MessageMetrics:
        """
        Parse the given Anthropic-specific usage into an Kern MessageMetrics object.
