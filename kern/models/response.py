...
from kern.metrics import ToolCallMetrics
from kern.models.message import Citations
from kern.models.metrics import MessageMetrics
from kern.tools.function import UserFeedbackQuestion, UserInputField
...
class ModelResponse:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ModelResponse":
        ...
        if data.get("response_usage") and isinstance(data["response_usage"], dict):
            from kern.models.metrics import MessageMetrics as _MessageMetrics
