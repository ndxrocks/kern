...
from kern.utils.models._mistral_compat import (
    AssistantMessage,
...
from kern.utils.models.mistral import format_messages
...
class MistralChat(Model):
    ...
    def _get_metrics(self, response_usage: Any) -> MessageMetrics:
        """
        Parse the given Mistral usage into an Kern MessageMetrics object.
