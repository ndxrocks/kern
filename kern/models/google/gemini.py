...
from kern.exceptions import ModelProviderError
from kern.media import Audio, File, Image, Video
from kern.models.base import Model, RetryableModelProviderError
from kern.models.google.utils import MALFORMED_FUNCTION_CALL_GUIDANCE, GeminiFinishReason
from kern.models.message import Citations, Message, UrlCitation
from kern.models.metrics import MessageMetrics
...
from kern.utils.gemini import format_function_definitions, format_image_for_message, prepare_response_schema
from kern.utils.log import log_debug, log_error, log_info, log_warning
from kern.utils.tokens import count_schema_tokens, count_text_tokens, count_tool_tokens
...
class Gemini(Model):
    ...
    def _format_messages(self, messages: List[Message], compress_tool_results: bool = False):
        ...
        """
        from kern.utils.message import normalize_tool_messages
    ...
    def _get_metrics(self, response_usage: GenerateContentResponseUsageMetadata) -> MessageMetrics:
        """
        Parse the given Google Gemini usage into an Kern MessageMetrics object.
