...
from kern.exceptions import ModelAuthenticationError, ModelProviderError
...
from kern.utils.openai import images_to_message
...
class Groq(Model):
    ...
    def _get_metrics(self, response_usage: CompletionUsage) -> MessageMetrics:
        """
        Parse the given Groq usage into an Kern MessageMetrics object.
