...
if TYPE_CHECKING:
    from kern.reasoning.manager import ReasoningEvent
...
def parse_response_with_parser_model(
    ...
    from kern.team._messages import _get_messages_for_parser_model
...
def parse_response_with_parser_model_stream(
    ...
    """Parse the model response using the parser model"""
    from kern.team._messages import _get_messages_for_parser_model_stream
...
def parse_response_with_output_model(team: "Team", model_response: ModelResponse, run_messages: RunMessages) -> None:
    ...
    from kern.team._messages import _get_messages_for_output_model
...
def generate_team_followups(
    ...
    from kern.agent._response import _build_followup_messages, _get_followups_response_format, _parse_followups_response
