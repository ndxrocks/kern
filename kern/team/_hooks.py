...
def handle_team_run_paused(
    ...
    from kern.run.approval import create_approval_from_pause
    from kern.team._run import _cleanup_and_store
...
async def ahandle_team_run_paused(
    ...
    from kern.run.approval import acreate_approval_from_pause
    from kern.team._run import _acleanup_and_store
...
def _execute_pre_hooks(
    ...
    **kwargs: Any,
    ...
    from kern.team._init import _set_debug
