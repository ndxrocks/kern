...
def _read_or_create_session(team: "Team", session_id: str, user_id: Optional[str] = None) -> TeamSession:
    ...
    from kern.team._telemetry import get_team_data
...
def from_dict(
    ...
    from kern.agent import get_agent_by_id
    from kern.team import get_team_by_id
