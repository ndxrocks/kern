...
async def _aresolve_callable_resources(team: "Team", run_context: "RunContext") -> None:
    ...
    from kern.utils.callables import aresolve_callable_knowledge, aresolve_callable_members, aresolve_callable_tools
...
async def _check_and_refresh_mcp_tools(team: "Team") -> None:
    # Connect MCP tools
    from kern.team._init import _connect_mcp_tools
...
def _determine_tools_for_model(
    ...
    from kern.team._default_tools import (
    ...
    from kern.team._init import _connect_connectable_tools
    from kern.team._messages import _get_user_message
    from kern.utils.callables import (
    ...
    if team.mode == TeamMode.tasks:
        ...
        from kern.team._task_tools import _get_task_management_tools
        from kern.team.task import load_task_list
