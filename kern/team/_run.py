...
from kern.exceptions import (
    InputCheckError,
    OutputCheckError,
    RunCancelledException,
)
from kern.filters import FilterExpr
from kern.media import Audio, File, Image, Video
from kern.models.base import Model
from kern.models.fallback import acall_model_with_fallback, call_model_with_fallback
from kern.models.message import Message
from kern.models.metrics import RunMetrics, merge_background_metrics
from kern.models.response import ModelResponse
from kern.run import RunContext, RunStatus
from kern.run.agent import RunOutput, RunOutputEvent
from kern.run.cancel import (
...
from kern.run.messages import RunMessages
...
from kern.session import TeamSession
from kern.tools.function import Function
from kern.utils.agent import (
...
from kern.utils.hooks import (
    normalize_post_hooks,
    normalize_pre_hooks,
)
from kern.utils.log import (
    log_debug,
    log_error,
    log_info,
    log_warning,
...
async def _asetup_session(
    ...
    from kern.team._init import _has_async_db, _initialize_session_state
    from kern.team._storage import (
...
def _run_tasks(
    ...
    **kwargs: Any,
    ...
    """
    from kern.team._hooks import _execute_post_hooks, _execute_pre_hooks
    from kern.team._init import _disconnect_connectable_tools
    from kern.team._managers import _start_learning_future, _start_memory_future
    from kern.team._messages import _get_run_messages
    from kern.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
        handle_reasoning,
    )
    from kern.team._telemetry import log_team_telemetry
    from kern.team._tools import _determine_tools_for_model
    from kern.team.task import TaskStatus, load_task_list
    ...
    try:
        ...
        from kern.team._response import generate_team_followups
...
def _run_tasks_stream(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        for iteration in range(team.max_iterations):
            ...
            if team.output_model is None:
                ...
                for event in _handle_model_response_stream(
                    ...
                    raise_if_cancelled(run_response.run_id)  # type: ignore
                    from kern.run.team import IntermediateRunContentEvent, RunContentEvent
        ...
        # Generate followups if enabled
        from kern.team._response import generate_team_followups_stream
...
def run_dispatch(
    ...
    **kwargs: Any,
    ...
    """Run the Team and return the response."""
    from kern.team._init import _has_async_db, _initialize_session, _initialize_session_state
    from kern.team._response import get_response_format
    from kern.team._run_options import resolve_run_options
    from kern.team._storage import _load_session_state, _read_or_create_session, _update_metadata
...
async def _arun_tasks(
    ...
    **kwargs: Any,
    ...
    the goal is complete or max_iterations is reached.
    """
    from kern.team._hooks import _aexecute_post_hooks, _aexecute_pre_hooks
    from kern.team._init import _disconnect_connectable_tools, _disconnect_mcp_tools
    from kern.team._managers import _astart_learning_task, _astart_memory_task
    from kern.team._messages import _aget_run_messages
    from kern.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
        ahandle_reasoning,
    )
    from kern.team._telemetry import alog_team_telemetry
    from kern.team._tools import _check_and_refresh_mcp_tools, _determine_tools_for_model
    from kern.team.task import TaskStatus, load_task_list
    ...
    try:
        ...
        # Generate followups if enabled
        from kern.team._response import agenerate_team_followups
...
async def _arun_tasks_stream(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        # Generate followups if enabled
        from kern.team._response import agenerate_team_followups_stream
    ...
    try:
        ...
        for attempt in range(num_attempts):
            ...
            try:
                ...
                from kern.team._tools import _aresolve_callable_resources
...
async def _arun_background(
    ...
    **kwargs: Any,
    ...
    """
    from kern.team._session import asave_session
    from kern.team._storage import _aread_or_create_session, _update_metadata
...
def arun_dispatch(  # type: ignore
    ...
    **kwargs: Any,
    ...
    from kern.team._init import _initialize_session
    from kern.team._response import get_response_format
    from kern.team._run_options import resolve_run_options
...
def _cleanup_and_store(
    ...
    from kern.run.approval import update_approval_run_status
    from kern.team._session import update_session_metrics
...
async def _acleanup_and_store(
    ...
    from kern.run.approval import aupdate_approval_run_status
    from kern.team._session import update_session_metrics
...
def _scrub_member_responses(team: "Team", member_responses: List[Union[TeamRunOutput, RunOutput]]) -> None:
    ...
    """
    from kern.team._tools import _find_member_by_id
    from kern.team.team import Team
    ...
    for member_response in member_responses:
        ...
        if not member.store_media or not member.store_tool_messages or not member.store_history_messages:
            from kern.agent._run import scrub_run_output_for_storage
...
def _get_continue_run_messages(
    ...
    if add_history_to_context and session is not None and not input_has_history:
        ...
        from kern.utils.message import filter_tool_calls
...
def _route_requirements_to_members(
    ...
    """
    from kern.run.requirement import RunRequirement
    from kern.team._tools import _find_member_route_by_id
    ...
    for member_id, reqs in member_reqs.items():
        ...
        if getattr(member_response, "is_paused", False):
            from kern.team._tools import _propagate_member_pause
...
def continue_run_dispatch(
    ...
    **kwargs: Any,
    ...
    """
    from kern.team._init import _has_async_db, _initialize_session
    from kern.team._response import get_response_format
    from kern.team._run_options import resolve_run_options
    from kern.team._storage import _load_session_state, _read_or_create_session, _update_metadata
    from kern.team._tools import _determine_tools_for_model
...
def _continue_run(
    ...
    **kwargs: Any,
    ...
    6. Cleanup and store
    """
    from kern.team._hooks import _execute_post_hooks
    from kern.team._init import _disconnect_connectable_tools
    from kern.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
    ...
    from kern.team._telemetry import log_team_telemetry
    from kern.utils.events import create_team_run_continued_event
...
async def _acontinue_run(
    ...
    **kwargs: Any,
    ...
    from kern.team._hooks import _aexecute_post_hooks
    from kern.team._init import _disconnect_connectable_tools, _disconnect_mcp_tools
    from kern.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
