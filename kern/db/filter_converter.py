...
Converts serialized FilterExpr dictionaries (from kern.filters) to database-native
...
Usage:
    >>> from kern.db.filter_converter import filter_expr_to_sqlalchemy, TRACE_COLUMNS
    >>>
