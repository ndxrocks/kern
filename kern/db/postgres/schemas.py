...
def _get_span_table_schema(traces_table_name: str = "kern_traces", db_schema: str = "kern") -> dict[str, Any]:
...
def _get_schedule_runs_table_schema(
    schedules_table_name: str = "kern_schedules", db_schema: str = "kern"
) -> dict[str, Any]:
