...
from kern.db.singlestore.schemas import get_table_schema_definition
from kern.db.singlestore.utils import (
    apply_sorting,
    bulk_upsert_metrics,
    ...
    def _create_table_structure_only(self, table_name: str, table_type: str) -> Table:
        ...
        try:
            ...
            table_schema = get_table_schema_definition(
                table_type, traces_table_name=self.trace_table_name, db_schema=self.db_schema or "kern"
            )
