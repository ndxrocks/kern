...
def _get_span_table_schema(traces_table_name: str = "kern_traces") -> dict[str, Any]:
...
def _get_schedule_runs_table_schema(schedules_table_name: str = "kern_schedules") -> dict[str, Any]:
...
def get_table_schema_definition(
    table_type: str,
    traces_table_name: str = "kern_traces",
    schedules_table_name: str = "kern_schedules",
) -> dict[str, Any]:
    """
