...
if TYPE_CHECKING:
    from kern.tracing.schemas import Span, Trace

from kern.db.schemas import UserMemory
from kern.db.schemas.culture import CulturalKnowledge
from kern.db.schemas.evals import EvalFilterType, EvalRunRecord, EvalType
from kern.db.schemas.knowledge import KnowledgeRow
from kern.run.base import RunStatus
from kern.session import Session
...
class BaseDb(ABC):
    ...
    def __init__(
        ...
        self.session_table_name = session_table or "kern_sessions"
        self.culture_table_name = culture_table or "kern_culture"
        self.memory_table_name = memory_table or "kern_memories"
        self.metrics_table_name = metrics_table or "kern_metrics"
        self.eval_table_name = eval_table or "kern_eval_runs"
        self.knowledge_table_name = knowledge_table or "kern_knowledge"
        self.trace_table_name = traces_table or "kern_traces"
        self.span_table_name = spans_table or "kern_spans"
        self.versions_table_name = versions_table or "kern_schema_versions"
        self.components_table_name = components_table or "kern_components"
        self.component_configs_table_name = component_configs_table or "kern_component_configs"
        self.component_links_table_name = component_links_table or "kern_component_links"
        self.learnings_table_name = learnings_table or "kern_learnings"
        self.schedules_table_name = schedules_table or "kern_schedules"
        self.schedule_runs_table_name = schedule_runs_table or "kern_schedule_runs"
        self.approvals_table_name = approvals_table or "kern_approvals"
