...
CULTURAL_KNOWLEDGE_TABLE_SCHEMA = {
    "TableName": "kern_cultural_knowledge",
    "KeySchema": [{"AttributeName": "id", "KeyType": "HASH"}],
    "AttributeDefinitions": [
        {"AttributeName": "id", "AttributeType": "S"},
