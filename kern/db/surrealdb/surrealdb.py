...
from kern.db.surrealdb import utils
from kern.db.surrealdb.metrics import (
    bulk_upsert_metrics,
...
from kern.db.surrealdb.models import (
    TableType,
...
from kern.db.surrealdb.queries import COUNT_QUERY, WhereClause, order_limit_start
from kern.db.surrealdb.utils import build_client
...
class SurrealDb(BaseDb):
    def __init__(
        ...
        self._db_ns = db_ns
        self._db_db = db_db
        self._users_table_name: str = "kern_users"
        self._agents_table_name: str = "kern_agents"
        self._teams_table_name: str = "kern_teams"
        self._workflows_table_name: str = "kern_workflows"
