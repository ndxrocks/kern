...
from kern.db.mongo.utils import (
    apply_pagination,
    apply_sorting,
    bulk_upsert_metrics,
...
from kern.db.utils import deserialize_session_json_fields
...
DRIVER_METADATA = DriverInfo(name="Kern", version=metadata.version("kern"))
...
class MongoDb(BaseDb):
    def __init__(
        ...
        if id is None:
            ...
            db_name_suffix = db_name if db_name is not None else "kern"
        ...
        self.db_name: str = db_name if db_name is not None else "kern"
    ...
    def get_trace(
        ...
        """
        try:
            from kern.tracing.schemas import Trace as TraceSchema
    ...
    def get_span(self, span_id: str):
        ...
        """
        try:
            from kern.tracing.schemas import Span as SpanSchema
