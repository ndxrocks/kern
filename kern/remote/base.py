...
from kern.run.workflow import WorkflowRunOutput, WorkflowRunOutputEvent
...
if TYPE_CHECKING:
    ...
    from kern.client.a2a.schemas import AgentCard
    from kern.os.routers.evals.schemas import EvalSchema
    ...
    from kern.os.routers.memory.schemas import OptimizeMemoriesResponse, UserMemorySchema, UserStatsSchema
    from kern.os.routers.metrics.schemas import DayAggregatedMetrics, MetricsResponse
    from kern.os.routers.traces.schemas import TraceDetail, TraceNode, TraceSessionStats, TraceSummary
...
class BaseRemote:
    ...
    def __init__(
        ...
        - "agentos": Kern's proprietary AgentOS REST API (default)
    ...
    def _config(self) -> Optional["ConfigResponse"]:
        ...
        from kern.os.schema import ConfigResponse
