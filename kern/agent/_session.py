...
def get_session(
    ...
    """
    from kern.agent import _init, _storage
...
async def aget_session(
    ...
    Returns:
        AgentSession: The AgentSession loaded from the database/cache or None if not found.
    """
    from kern.agent import _storage
...
def update_session_metrics(agent: Agent, session: AgentSession, run_response: RunOutput) -> None:
    ...
    from kern.agent._storage import update_session_metrics as _update_session_metrics_storage
