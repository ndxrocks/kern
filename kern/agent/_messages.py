...
from kern.agent._utils import convert_dependencies_to_string, convert_documents_to_string
...
from kern.utils.common import is_typed_dict
from kern.utils.log import log_debug, log_warning
from kern.utils.message import filter_tool_calls, get_text_from_message
from kern.utils.prompts import get_json_output_prompt, get_response_model_format_prompt
...
def get_system_message(
    ...
    # Extract values from run_context
    from kern.agent._init import set_culture_manager, set_memory_manager
    ...
    if agent.add_location_to_context:
        from kern.utils.location import get_location
...
async def aget_system_message(
    ...
    # Extract values from run_context
    from kern.agent._init import has_async_db, set_culture_manager, set_memory_manager
