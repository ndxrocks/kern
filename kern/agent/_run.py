...
from kern.agent._init import _initialize_session_state
from kern.agent._run_options import resolve_run_options
from kern.agent._session import initialize_session, update_session_metrics
...
from kern.models.response import ModelResponse, ToolExecution
...
from kern.session import AgentSession
...
from kern.utils.response import get_paused_content
...
def _run(
    ...
    **kwargs: Any,
    ...
    """
    from kern.agent._hooks import execute_post_hooks, execute_pre_hooks
    from kern.agent._init import disconnect_connectable_tools
    from kern.agent._messages import get_run_messages
    from kern.agent._response import (
    ...
    from kern.agent._storage import load_session_state, read_or_create_session, update_metadata
    from kern.agent._telemetry import log_agent_telemetry
    from kern.agent._tools import determine_tools_for_model
    ...
    try:
        ...
        for attempt in range(num_attempts):
            ...
            try:
                ...
                from kern.agent import _managers
...
def run_dispatch(
    ...
    **kwargs: Any,
    ...
    from kern.agent._init import has_async_db
    from kern.agent._response import get_response_format
    ...
    from kern.agent._storage import read_or_create_session, update_metadata
...
async def _arun(
    ...
    **kwargs: Any,
    ...
    """
    from kern.agent._hooks import aexecute_post_hooks, aexecute_pre_hooks
    from kern.agent._init import disconnect_connectable_tools, disconnect_mcp_tools
    from kern.agent._messages import aget_run_messages
    from kern.agent._response import (
        agenerate_followups,
    ...
    from kern.agent._storage import aread_or_create_session, load_session_state, update_metadata
    from kern.agent._telemetry import alog_agent_telemetry
    from kern.agent._tools import determine_tools_for_model
...
async def _arun_background(
    ...
    **kwargs: Any,
    ...
    """
    from kern.agent._session import asave_session
    from kern.agent._storage import aread_or_create_session, update_metadata
...
def arun_dispatch(  # type: ignore
    ...
    **kwargs: Any,
    ...
    from kern.agent._init import has_async_db
    from kern.agent._storage import update_metadata

    _pre_session: Optional[AgentSession] = None
    if not has_async_db(agent):
        from kern.agent._storage import read_or_create_session
...
def continue_run_dispatch(
    ...
    **kwargs,
    ...
    """
    from kern.agent._init import has_async_db, set_default_model
    from kern.agent._messages import get_continue_run_messages
    from kern.agent._response import get_response_format
    from kern.agent._storage import load_session_state, read_or_create_session, update_metadata
    from kern.agent._tools import determine_tools_for_model
    ...
    if run_response is not None:
        ...
        # If no tools/requirements provided, check for resolved admin approval
            ...
            from kern.run.approval import check_and_apply_approval_resolution
...
def _continue_run(
    ...
    **kwargs,
    ...
    from kern.agent._hooks import execute_post_hooks
    from kern.agent._init import disconnect_connectable_tools
    from kern.agent._response import (
        convert_response_to_structured_format,
        generate_followups,
    ...
    from kern.agent._telemetry import log_agent_telemetry
    from kern.agent._tools import handle_tool_call_updates
...
def _continue_run_stream(
    ...
    **kwargs,
    ...
    from kern.agent._telemetry import log_agent_telemetry
    from kern.agent._tools import handle_tool_call_updates_stream
...
async def _acontinue_run(
    ...
    **kwargs,
    ...
    """
    from kern.agent._hooks import aexecute_post_hooks
    from kern.agent._init import disconnect_connectable_tools, disconnect_mcp_tools
    from kern.agent._messages import get_continue_run_messages
    from kern.agent._response import (
        agenerate_followups,
    ...
    from kern.agent._storage import aread_or_create_session, load_session_state, update_metadata
    from kern.agent._telemetry import alog_agent_telemetry
    from kern.agent._tools import ahandle_tool_call_updates, determine_tools_for_model
            ...
            try:
                ...
                if run_response is not None:
                    ...
                    # If no tools/requirements provided, check for resolved admin approval
                        ...
                        from kern.run.approval import acheck_and_apply_approval_resolution
...
async def _acontinue_run_stream(
    ...
    **kwargs,
    ...
    from kern.agent._storage import aread_or_create_session, load_session_state, update_metadata
    from kern.agent._telemetry import alog_agent_telemetry
    from kern.agent._tools import ahandle_tool_call_updates_stream, determine_tools_for_model
...
def cleanup_and_store(
    ...
    from kern.agent import _session
...
# ---------------------------------------------------------------------------
# Run cancellation — re-export from kern.run.cancel
# ---------------------------------------------------------------------------
