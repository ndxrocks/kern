...
from kern.db.base import AsyncBaseDb, BaseDb, ComponentType, UserMemory
...
from kern.session import AgentSession, SessionSummaryManager, TeamSession, WorkflowSession
from kern.session.summary import SessionSummary
from kern.skills import Skills
...
class Agent:
    ...
    def background_executor(self) -> Any:
        if self._background_executor is None:
            ...
            self._background_executor = ThreadPoolExecutor(max_workers=3, thread_name_prefix="kern-bg")
    ...
    async def aclear_callable_cache(
        ...
        from kern.utils.callables import aclear_callable_cache
