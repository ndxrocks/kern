...
from kern.session import AgentSession, TeamSession, WorkflowSession
...
def to_dict(agent: Agent) -> Dict[str, Any]:
    ...
    """
    from kern.agent._tools import parse_tools
...
def from_dict(cls: Type[Agent], data: Dict[str, Any], registry: Optional[Registry] = None) -> Agent:
    ...
    #     from kern.culture import CultureManager
