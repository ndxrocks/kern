...
class ReaderFactory:
    ...
    def _get_docx_reader(cls, **kwargs) -> Reader:
        ...
        from kern.knowledge.reader.docx_reader import DocxReader
    ...
    def _get_youtube_reader(cls, **kwargs) -> Reader:
        ...
        from kern.knowledge.reader.youtube_reader import YouTubeReader
    ...
    def get_reader_class(cls, reader_key: str) -> type:
        ...
        reader_class_map: Dict[str, tuple] = {
            "pdf": ("kern.knowledge.reader.pdf_reader", "PDFReader"),
            "csv": ("kern.knowledge.reader.csv_reader", "CSVReader"),
            "excel": ("kern.knowledge.reader.excel_reader", "ExcelReader"),
            "field_labeled_csv": ("kern.knowledge.reader.field_labeled_csv_reader", "FieldLabeledCSVReader"),
            "docx": ("kern.knowledge.reader.docx_reader", "DocxReader"),
            "pptx": ("kern.knowledge.reader.pptx_reader", "PPTXReader"),
            "json": ("kern.knowledge.reader.json_reader", "JSONReader"),
            "markdown": ("kern.knowledge.reader.markdown_reader", "MarkdownReader"),
            "text": ("kern.knowledge.reader.text_reader", "TextReader"),
            "website": ("kern.knowledge.reader.website_reader", "WebsiteReader"),
            "firecrawl": ("kern.knowledge.reader.firecrawl_reader", "FirecrawlReader"),
            "tavily": ("kern.knowledge.reader.tavily_reader", "TavilyReader"),
            "youtube": ("kern.knowledge.reader.youtube_reader", "YouTubeReader"),
            "arxiv": ("kern.knowledge.reader.arxiv_reader", "ArxivReader"),
            "wikipedia": ("kern.knowledge.reader.wikipedia_reader", "WikipediaReader"),
            "web_search": ("kern.knowledge.reader.web_search_reader", "WebSearchReader"),
            "docling": ("kern.knowledge.reader.docling_reader", "DoclingReader"),
        }
