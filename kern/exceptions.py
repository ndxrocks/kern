...
class KernError(Exception):
    ...
    def __init__(self, message: str, status_code: int = 500):
        ...
        self.type = "kern_error"
        self.error_id = "kern_error"

    def __str__(self) -> str:
        return str(self.message)


class ModelAuthenticationError(KernError):
...
class ModelProviderError(KernError):
...
class RemoteServerUnavailableError(KernError):
